...
export default function UploadArtwork() {
  ...
  const [form, setForm] = useState({
    judul: '', deskripsi: '', tipe: 'image', id_prodi: user?.id_prodi || '',
  })
  ...
  const accept = { image: '.jpg,.jpeg,.png', video: '.mp4', '3d': '.glb,.gltf' }
  const tipeIcon = { image: '🖼️', video: '🎬', '3d': '🎲' }

  const submit = async (e) => {
    e.preventDefault()
    if (!file) { toast.error('Pilih file karya terlebih dahulu!'); return }
    setErrors({})
    setLoading(true)
    setProgress(0)
    ...
    <div className="min-h-screen bg-gray-950 pt-16">
      ...
      <div className="max-w-2xl mx-auto px-4 py-10">
        <div className="mb-8">
          ...
          <p className="text-white/50 mt-1">Karya akan diverifikasi admin sebelum ditampilkan</p>
        </div>
          ...
          <form onSubmit={submit} className="space-y-5">
            ...
            */}
            <div>
              ...
              {/* Visual dropzone — no click handler, no pointer events to file input */}
              <div
              ...
              >
                {filePreview ? (
                  ...
                  <div className="space-y-2">
                    <span className="text-4xl">{tipeIcon[form.tipe]}</span>
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-white/50">Klik tombol di bawah untuk memilih file</p>
            ...
            <div className="p-3 bg-blue-900/20 border border-blue-500/20 rounded-xl text-xs text-blue-300">
              📋 Karya Anda akan direview oleh admin sebelum ditampilkan di galeri. Proses biasanya 1-2 hari kerja.
            </div>
