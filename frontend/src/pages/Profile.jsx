  ...
  return (
    <div className="min-h-screen pt-16 bg-gray-950">
      ...
      <div className="max-w-2xl px-4 py-10 mx-auto">
        <h1 className="mb-8 text-3xl font-bold text-white">Pengaturan Akun</h1>

        {/* Tabs */}
        <div className="flex gap-1 p-1 mb-8 bg-white/5 rounded-xl">
          {[
            ["profile", "👤 Profil"],
            ...
            <form onSubmit={submitProfile} className="space-y-5">
              ...
              <div className="flex items-center gap-5">
                <div className="relative">
                  <div className="flex items-center justify-center w-20 h-20 overflow-hidden bg-primary-600 rounded-2xl">
                    {avatarPreview ? (
                      <img
                        src={avatarPreview}
                        alt="Avatar"
                  ...
                  {/* <label className="absolute flex items-center justify-center transition-colors rounded-full cursor-pointer -bottom-2 -right-2 w-7 h-7 bg-primary-600 hover:bg-primary-700">
                ...
                <div>
                  ...
                  {/* <p className="mt-1 text-xs text-white/30">
                    Klik ikon pensil untuk ganti foto
                  </p> */}
                </div>
              </div>
                ...
                <>
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setProfileForm({ ...profileForm, nim: e.target.value })
                      }
                      className="input"
